...
public class Matrizes {
	...
	public static void main(String[] args) {
		 ...
		 * Ao lado da media do aluno deve seguir a seguinte regra de negocio.
		...
		*/
		...
		for (int i = 0; i < 3; i++) {
			...
			mediaAluno = 0;
			for (int j = 0; j < 4; j++) {
				notas[i][j] = Float.parseFloat(JOptionPane.showInputDialog("Informe a nota na " + (j+1) + " do aluno " + alunos[i]));
